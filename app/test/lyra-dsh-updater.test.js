...
const { createUpdater, createFeedTarget, compareVersions, createElectronUpdaterTarget, createNpmPackageTarget } = require('@omnilyra/lyra-dsh-updater')
...
test('compareVersions orders prerelease versions', () => {
  assert.ok(compareVersions('1.0.0', '1.0.0-alpha') > 0) // 正式版 > alpha
  assert.ok(compareVersions('0.1.2', '0.1.2-alpha.3') > 0)
  assert.ok(compareVersions('0.1.2-alpha.4', '0.1.2-alpha.3') > 0)
